        ...
        <div className="max-w-2xl mx-auto pt-8">
            ...
            {file && (
                <div className="mt-8 p-6 bg-surface border border-outline-variant/30 rounded-2xl flex flex-col gap-4 text-left">
                    <div className="mb-2">
                        <label className="block text-sm font-medium text-on-surface mb-2">{t('upload.languageTitle')}</label>
                        <select
                            className="w-full bg-surface-container text-on-surface px-4 py-3 rounded-xl border border-outline-variant/50 focus:outline-none focus:ring-2 focus:ring-primary/50 cursor-pointer appearance-none"
                            value={diarizationOptions?.language || 'auto'}
                            onChange={(e) => setDiarizationOptions(prev => ({ ...prev, language: e.target.value }))}
                        ...
                        >
                            ...
                            <option value="es">{t('upload.langEs')}</option>
                            <option value="en">{t('upload.langEn')}</option>
                        </select>
                    </div>

                    <div className="h-px bg-outline-variant/20 w-full my-1"></div>
