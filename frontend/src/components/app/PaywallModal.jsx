            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold font-headline text-white mb-2">Límite Mensual Alcanzado</h2>
                        <p className="text-on-surface-variant text-sm">
                            Haz usado tus 30 minutos gratuitos de este mes. Actualiza tu plan para continuar transcribiendo sin interrupciones.
                        </p>
                    </div>
                    ...
                    <div className="bg-surface-container rounded-2xl p-6 border border-white/5 mb-6 relative overflow-hidden group">
                        ...
                        <div className="flex justify-between items-center mb-4 relative z-10">
                            <div>
                                ...
                                <p className="text-xs text-secondary font-medium">B2B / Profesionales</p>
                            </div>
                        ...
                        <ul className="space-y-3 mb-6 relative z-10">
                            {[
                                'Hasta 1200 minutos (20 horas) mensuales',
                                'Límite de 120 minutos por archivo',
                                'Soporte prioritario y Exportación PRO',
                                'Privacidad absoluta Zero-Retention'
                            ].map((feature, i) => (
                    ...
                    <p className="text-xs text-center text-on-surface-variant">
                        Pagos procesados de forma segura vía MercadoPago. Cancela cuando quieras.
                    </p>
                </motion.div>
            </div>
        </AnimatePresence>
