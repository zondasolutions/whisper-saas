        ...
        <nav className="fixed top-0 w-full z-50 bg-[#121317]/80 backdrop-blur-xl transition-all duration-300 border-b border-white/5">
            <div className="max-w-7xl mx-auto flex justify-between items-center px-8 py-4">
                ...
                <div className="hidden md:flex items-center gap-8">
                    <Link to="/features" className="text-gray-400 hover:text-white transition-colors font-semibold text-sm">{t('navbar.features')}</Link>
                    <Link to="/pricing" className="text-gray-400 hover:text-white transition-colors text-sm">{t('navbar.pricing')}</Link>
                    <Link to="/about" className="text-gray-400 hover:text-white transition-colors text-sm">{t('navbar.about')}</Link>
                    <Link to="/contact" className="text-gray-400 hover:text-white transition-colors text-sm">{t('navbar.contact')}</Link>
                </div>
