            ...
            <div className="max-w-7xl mx-auto px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    <div className="space-y-1">
                        ...
                        <div className="text-sm text-gray-500 font-medium tracking-widest uppercase">{t('stats.minutes')}</div>
                    </div>
                    <div className="space-y-1">
                        <div className="text-4xl font-bold font-headline text-secondary tracking-tighter">99.2%</div>
                        <div className="text-sm text-gray-500 font-medium tracking-widest uppercase">{t('stats.accuracy')}</div>
                    </div>
                    <div className="space-y-1">
                        <div className="text-4xl font-bold font-headline text-white tracking-tighter">&lt; 30s</div>
                        <div className="text-sm text-gray-500 font-medium tracking-widest uppercase">{t('stats.turnaround')}</div>
                    </div>
                </div>
            </div>
        </section>
